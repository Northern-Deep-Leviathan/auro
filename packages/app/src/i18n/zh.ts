...
export const dict = {
  ...
  "settings.agents.n8n.section.title": "N8n 集成",
  "settings.agents.n8n.section.description": "配置你的 n8n 实例，通过 OpenCode 管理工作流。",
  "settings.agents.n8n.url.title": "实例 URL",
  "settings.agents.n8n.url.description": "你的 n8n 实例的 URL",
  "settings.agents.n8n.url.placeholder": "https://your-n8n.example.com",
  "settings.agents.n8n.url.error.required": "URL 为必填项",
  "settings.agents.n8n.url.error.format": "必须以 http:// 或 https:// 开头",
  "settings.agents.n8n.apiKey.title": "API 密钥",
  "settings.agents.n8n.apiKey.description": "用于身份验证的 n8n API 密钥",
  "settings.agents.n8n.apiKey.placeholder": "输入你的 n8n API 密钥",
  "settings.agents.n8n.apiKey.error.required": "API 密钥为必填项",
  "settings.agents.n8n.test": "测试连接",
  "settings.agents.n8n.testing": "测试中...",
  "settings.agents.n8n.save": "保存",
  "settings.agents.n8n.saving": "保存中...",
  "settings.agents.n8n.status.connected": "已连接",
  "settings.agents.n8n.status.notConfigured": "未配置",
  "settings.agents.n8n.status.failed": "连接失败",
  "settings.agents.n8n.toast.saved.title": "N8n 配置已保存",
  "settings.agents.n8n.toast.saved.description": "你的 n8n 实例已成功配置。",
  "settings.agents.n8n.toast.saveFailed.title": "保存 n8n 配置失败",
  "settings.agents.n8n.toast.testSuccess.title": "连接成功",
  "settings.agents.n8n.toast.testSuccess.description": "已成功连接到你的 n8n 实例。",
  "settings.agents.n8n.toast.testFailed.title": "连接失败",
