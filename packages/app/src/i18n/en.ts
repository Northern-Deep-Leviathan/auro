export const dict = {
  ...
  "settings.agents.n8n.section.title": "N8n Integration",
  "settings.agents.n8n.section.description": "Configure your n8n instance to manage workflows through OpenCode.",
  "settings.agents.n8n.url.title": "Instance URL",
  "settings.agents.n8n.url.description": "The URL of your n8n instance",
  "settings.agents.n8n.url.placeholder": "https://your-n8n.example.com",
  "settings.agents.n8n.url.error.required": "URL is required",
  "settings.agents.n8n.url.error.format": "Must start with http:// or https://",
  "settings.agents.n8n.apiKey.title": "API Key",
  "settings.agents.n8n.apiKey.description": "Your n8n API key for authentication",
  "settings.agents.n8n.apiKey.placeholder": "Enter your n8n API key",
  "settings.agents.n8n.apiKey.error.required": "API key is required",
  "settings.agents.n8n.test": "Test Connection",
  "settings.agents.n8n.testing": "Testing...",
  "settings.agents.n8n.save": "Save",
  "settings.agents.n8n.saving": "Saving...",
  "settings.agents.n8n.status.connected": "Connected",
  "settings.agents.n8n.status.notConfigured": "Not configured",
  "settings.agents.n8n.status.failed": "Connection failed",
  "settings.agents.n8n.toast.saved.title": "N8n configuration saved",
  "settings.agents.n8n.toast.saved.description": "Your n8n instance has been configured successfully.",
  "settings.agents.n8n.toast.saveFailed.title": "Failed to save n8n configuration",
  "settings.agents.n8n.toast.testSuccess.title": "Connection successful",
  "settings.agents.n8n.toast.testSuccess.description": "Successfully connected to your n8n instance.",
  "settings.agents.n8n.toast.testFailed.title": "Connection failed",
